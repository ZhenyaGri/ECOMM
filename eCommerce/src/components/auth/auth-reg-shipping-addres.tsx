...
import { countries, shippingFields } from "./data-list";
import { IWarnRefObj, ILogIn, IRemaindPass, ICreateAccount } from "./type/auth-types";
import { inputHandler } from "./form-handler";

interface ShippingAddressComponentProps {
  setNewAccount: React.Dispatch<React.SetStateAction<ICreateAccount | ILogIn | IRemaindPass>>;
